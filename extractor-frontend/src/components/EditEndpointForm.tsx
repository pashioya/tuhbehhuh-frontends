...
type EditEndpointFields = Omit<Endpoint, "uuid" | "requestParams">;
...
const endpointSchema: ZodType<EditEndpointFields> = z.object({
    apiUUID: z.string(),
    name: z.string(),
...
export function EditEndpointForm() {
    ...
    const {
        ...
        defaultValues: {
            ...
            endpointPath: currentEndpoint?.endpointPath,
            requestParams: currentEndpoint?.requestParams,
            active: currentEndpoint?.active,
            timeInterval: currentEndpoint?.timeInterval,
            timeUnit: currentEndpoint?.timeUnit,
        },
    });
